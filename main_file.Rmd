...
The model trained on uncleaned data achieves higher accuracy solely because it exploits unrealistic zero values as artificial indicators of diagnosis. After cleaning, accuracy decreases slightly, but performance becomes more reliable and more representative of real-world usage.
